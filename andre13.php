...
echo color("green"," =================================== \n");
echo " Created by : versi terbaru \n";
echo " Version    : hati hati banyak driver kibus \n";
...
//	function change(){
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo color("green","\n===========(REDEEM VOUCHER)===========");
				echo "\n".color("yellow","!] Claim Voc VOUCER GOCAR");
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					echo "\n".color("yellow","!] Claim Voc GOFOOD TERBARU");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					goride:
					echo "\n".color("yellow","!] Claim Voc VOUCHER GORIDE");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEGOFOOD090320A"}');
