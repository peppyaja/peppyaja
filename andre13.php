<?php
date_default_timezone_set('Asia/Bekasi');
include "function.php";
echo color("green"," =================================== \n");
echo color("green"," Claim Voucher \n");
echo color("green"," Auto Create & Redeem Voucher \n");
echo color("green"," =================================== \n");
echo " Created by : rahasia\n";
echo " Version    : tetap rahasia\n";
...
//	function change(){
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo color("green","\n===========(REDEEM VOUCHER)===========");
				echo "\n".color("yellow","!] Claim Voc hepimalam minggu");
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					sleep(3);
					$boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HEPIUPNORMAL"}');
					...
					sleep(3);
					$goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HEPIASIX"}');
					$message1 = fetch_value($goride,'"message":"','"');
					echo "\n".color("green","+] Message: ".$message1);
							
					echo "\n".color("yellow","!] Claim Voc 15+10+5");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
