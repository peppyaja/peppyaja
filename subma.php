...
//	function change(){
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo color("green","\n===========(REDEEM VOUCHER)===========");
				echo "\n".color("yellow","!] Claim Voc BURGER BROS");
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					echo "\n".color("yellow","!] Claim Voc GO FOOD TERBARU");
					echo "\n".color("yellow","!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					sleep(3);
					$boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEGOFOOD090320B"}');
					...
					sleep(3);
					$goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HEPIORINS"}');
